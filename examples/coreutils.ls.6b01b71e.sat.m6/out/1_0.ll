; ModuleID = '/tmp/sea-s5xlynxv/1_0.pp.ms.o.bc'
source_filename = "1_0.c"
...
entry:
  ...
  %or.cond.i = select i1 %_17, i1 %_18, i1 false
  %or.cond.not.i = xor i1 %or.cond.i, true
  %or.cond3.i = select i1 %or.cond.not.i, i1 true, i1 %_16
  %or.cond5.i = select i1 %or.cond3.i, i1 true, i1 %_13
  %or.cond7.i = select i1 %or.cond5.i, i1 true, i1 %_14
  %_22 = icmp ne i32 %_11, 0
  %or.cond9.not.i = select i1 %or.cond7.i, i1 true, i1 %_22
  %or.cond11.i = select i1 %or.cond9.not.i, i1 true, i1 %_15
  br i1 %or.cond11.i, label %orig.main.exit, label %_23

_23:                                              ; preds = %entry
  %or.cond13.i = select i1 %_17, i1 %_18, i1 false
  %or.cond13.not.i = xor i1 %or.cond13.i, true
  %or.cond15.i = select i1 %or.cond13.not.i, i1 true, i1 %_13
  %or.cond17.i = select i1 %or.cond15.i, i1 true, i1 %_15
  %or.cond19.i = select i1 %or.cond17.i, i1 true, i1 %_14
  %or.cond19.not.i = xor i1 %or.cond19.i, true
  %_24 = icmp eq i32 %_10, 0
  %or.cond23.i = select i1 %or.cond19.not.i, i1 %_24, i1 false
  %_25 = xor i1 %_16, true
  %_26 = select i1 %or.cond23.i, i1 %_25, i1 false
  br label %orig.main.exit

orig.main.exit:                                   ; preds = %_23, %entry
  %_27 = phi i1 [ false, %entry ], [ %_26, %_23 ]
...
_34:                                              ; preds = %_31
  br i1 %_15, label %_35, label %_38

_35:                                              ; preds = %_34
  %_36 = sub nsw i64 %_5, %_4
  %_37 = add nsw i64 %_5, %_4
  br label %_56

_38:                                              ; preds = %_34
  br i1 %_16, label %_39, label %_42

_39:                                              ; preds = %_38
  %_40 = sub nsw i64 %_7, %_6
  %_41 = sub nsw i64 %_7, %_6
  br label %_56

_42:                                              ; preds = %_38
  br i1 %_17, label %_43, label %_56
...
_43:                                              ; preds = %_42
  ...
  %.neg.i = sext i1 %_48 to i64
  %_49 = add nsw i64 %.neg.i, %_46
  %_50 = and i32 %_9, 61440
  %_51 = icmp eq i32 %_50, 16384
  %_52 = zext i1 %_51 to i64
  %_53 = and i32 %_8, 61440
  %_54 = icmp eq i32 %_53, 16384
  %.neg8.i = sext i1 %_54 to i64
  %_55 = add nsw i64 %.neg8.i, %_52
  br label %_56

_56:                                              ; preds = %_43, %_42, %_39, %_35, %_32, %_29
  %.01.i = phi i64 [ %_30, %_29 ], [ %_33, %_32 ], [ %_36, %_35 ], [ %_40, %_39 ], [ %_49, %_43 ], [ 0, %_42 ]
  %.0.i = phi i64 [ %_30, %_29 ], [ %_33, %_32 ], [ %_37, %_35 ], [ %_41, %_39 ], [ %_55, %_43 ], [ 0, %_42 ]
  %_57 = icmp eq i64 %.01.i, 0
  %spec.select12.v.i = select i1 %_19, i32 %_10, i32 %_11
  %spec.select12.i = sext i32 %spec.select12.v.i to i64
  %.23.i = select i1 %_57, i64 %spec.select12.i, i64 %.01.i
  %_58 = icmp eq i64 %.0.i, 0
  %spec.select13.v.i = select i1 %_19, i32 %_10, i32 %_11
  %spec.select13.i = sext i32 %spec.select13.v.i to i64
  %.2.i = select i1 %_58, i64 %spec.select13.i, i64 %.0.i
  %.not.i = icmp eq i64 %.23.i, 0
  br i1 %.not.i, label %_62, label %_59

_59:                                              ; preds = %_56
  %.45.i = ashr i64 %.23.i, 32
  %_60 = srem i64 %.45.i, 2
  %_61 = add nsw i64 %.45.i, %_60
  br label %_62

_62:                                              ; preds = %_59, %_56
  %.56.i = phi i64 [ %_61, %_59 ], [ %.23.i, %_56 ]
  %.not7.i = icmp eq i64 %.2.i, 0
  br i1 %.not7.i, label %_67, label %_63

_63:                                              ; preds = %_62
  %_64 = ashr i64 %.2.i, 32
  %.4.i = select i1 %_20, i64 0, i64 %_64
  %_65 = srem i64 %.4.i, 2
  %_66 = add nsw i64 %.4.i, %_65
  br label %_67

_67:                                              ; preds = %_63, %_62
  %.5.i = phi i64 [ %_66, %_63 ], [ %.2.i, %_62 ]
  %_68 = trunc i64 %.56.i to i32
  %_69 = sub nsw i32 0, %_68
  %_70 = trunc i64 %.56.i to i32
  %_71 = select i1 %_18, i32 %_69, i32 %_70
  %_72 = trunc i64 %.5.i to i32
  %_73 = sub nsw i32 0, %_72
  %_74 = trunc i64 %.5.i to i32
  %_75 = select i1 %_18, i32 %_73, i32 %_74
  %_76 = icmp eq i32 %_71, %_75
  call void @verifier.assume.not(i1 %_76)
  br label %_77

_77:                                              ; preds = %_67
  br label %verifier.error

verifier.error:                                   ; preds = %_77
