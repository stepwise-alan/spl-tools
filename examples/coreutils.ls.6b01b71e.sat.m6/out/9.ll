; ModuleID = '/tmp/sea-8yaeaw17/9.pp.ms.o.bc'
source_filename = "9.c"
...
sortcmp:                                          ; preds = %precall
  call void @seahorn.fn.enter() #7
  br i1 %_13, label %_30, label %_33

_30:                                              ; preds = %sortcmp
  %_31 = add nsw i64 %_1, %_0
  %_32 = sub nsw i64 %_1, %_0
  br label %_59

_33:                                              ; preds = %sortcmp
  br i1 %_14, label %_34, label %_37

_34:                                              ; preds = %_33
  %_35 = add nsw i64 %_3, %_2
  %_36 = sub nsw i64 %_3, %_2
  br label %_59

_37:                                              ; preds = %_33
  br i1 %_15, label %_38, label %_41

_38:                                              ; preds = %_37
  %_39 = add nsw i64 %_5, %_4
  %_40 = sub nsw i64 %_5, %_4
  br label %_59

_41:                                              ; preds = %_37
  br i1 %_16, label %_42, label %_45
...
_46:                                              ; preds = %_45
  ...
  %.neg8.i = sext i1 %_57 to i64
  %_58 = add nsw i64 %.neg8.i, %_55
  br label %_59

_59:                                              ; preds = %_46, %_45, %_42, %_38, %_34, %_30
  %.01.i = phi i64 [ %_31, %_30 ], [ %_35, %_34 ], [ %_39, %_38 ], [ %_43, %_42 ], [ %_52, %_46 ], [ 0, %_45 ]
  %.0.i = phi i64 [ %_32, %_30 ], [ %_36, %_34 ], [ %_40, %_38 ], [ %_44, %_42 ], [ %_58, %_46 ], [ 0, %_45 ]
  %_60 = icmp eq i64 %.01.i, 0
  %spec.select12.v.i = select i1 %_19, i32 %_10, i32 %_11
  %spec.select12.i = sext i32 %spec.select12.v.i to i64
  %.23.i = select i1 %_60, i64 %spec.select12.i, i64 %.01.i
  %_61 = icmp eq i64 %.0.i, 0
  %spec.select13.v.i = select i1 %_19, i32 %_10, i32 %_11
  %spec.select13.i = sext i32 %spec.select13.v.i to i64
  %.2.i = select i1 %_61, i64 %spec.select13.i, i64 %.0.i
  %.not.i = icmp eq i64 %.23.i, 0
  br i1 %.not.i, label %_65, label %_62

_62:                                              ; preds = %_59
  %.45.i = ashr i64 %.23.i, 32
  %_63 = srem i64 %.45.i, 2
  %_64 = add nsw i64 %.45.i, %_63
  br label %_65

_65:                                              ; preds = %_62, %_59
  %.56.i = phi i64 [ %_64, %_62 ], [ %.23.i, %_59 ]
  %.not7.i = icmp eq i64 %.2.i, 0
  br i1 %.not7.i, label %_70, label %_66

_66:                                              ; preds = %_65
  %_67 = ashr i64 %.2.i, 32
  %.4.i = select i1 %_20, i64 %_67, i64 0
  %_68 = srem i64 %.4.i, 2
  %_69 = add nsw i64 %.4.i, %_68
  br label %_70

_70:                                              ; preds = %_66, %_65
  %.5.i = phi i64 [ %_69, %_66 ], [ %.2.i, %_65 ]
