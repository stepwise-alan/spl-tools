; ModuleID = '/tmp/sea-owzna_cj/8.pp.ms.o.bc'
source_filename = "8.c"
...
sortcmp:                                          ; preds = %precall
  call void @seahorn.fn.enter() #7
  br i1 %_13, label %_29, label %_32

_29:                                              ; preds = %sortcmp
  %_30 = add nsw i64 %_1, %_0
  %_31 = sub nsw i64 %_1, %_0
  br label %_58

_32:                                              ; preds = %sortcmp
  br i1 %_14, label %_33, label %_36

_33:                                              ; preds = %_32
  %_34 = add nsw i64 %_3, %_2
  %_35 = sub nsw i64 %_3, %_2
  br label %_58

_36:                                              ; preds = %_32
  br i1 %_15, label %_37, label %_40

_37:                                              ; preds = %_36
  %_38 = add nsw i64 %_5, %_4
  %_39 = sub nsw i64 %_5, %_4
  br label %_58

_40:                                              ; preds = %_36
  br i1 %_16, label %_41, label %_44
...
_45:                                              ; preds = %_44
  ...
  %.neg8.i = sext i1 %_56 to i64
  %_57 = add nsw i64 %.neg8.i, %_54
  br label %_58

_58:                                              ; preds = %_45, %_44, %_41, %_37, %_33, %_29
  %.01.i = phi i64 [ %_30, %_29 ], [ %_34, %_33 ], [ %_38, %_37 ], [ %_42, %_41 ], [ %_51, %_45 ], [ 0, %_44 ]
  %.0.i = phi i64 [ %_31, %_29 ], [ %_35, %_33 ], [ %_39, %_37 ], [ %_43, %_41 ], [ %_57, %_45 ], [ 0, %_44 ]
  %_59 = icmp eq i64 %.01.i, 0
  %spec.select12.v.i = select i1 %_19, i32 %_10, i32 %_11
  %spec.select12.i = sext i32 %spec.select12.v.i to i64
  %.23.i = select i1 %_59, i64 %spec.select12.i, i64 %.01.i
  %_60 = icmp eq i64 %.0.i, 0
  %spec.select13.v.i = select i1 %_19, i32 %_10, i32 %_11
  %spec.select13.i = sext i32 %spec.select13.v.i to i64
  %.2.i = select i1 %_60, i64 %spec.select13.i, i64 %.0.i
  %.not.i = icmp eq i64 %.23.i, 0
  br i1 %.not.i, label %_64, label %_61

_61:                                              ; preds = %_58
  %.45.i = ashr i64 %.23.i, 32
  %_62 = srem i64 %.45.i, 2
  %_63 = add nsw i64 %.45.i, %_62
  br label %_64

_64:                                              ; preds = %_61, %_58
  %.56.i = phi i64 [ %_63, %_61 ], [ %.23.i, %_58 ]
  %.not7.i = icmp eq i64 %.2.i, 0
  br i1 %.not7.i, label %_69, label %_65

_65:                                              ; preds = %_64
  %_66 = ashr i64 %.2.i, 32
  %.4.i = select i1 %_20, i64 %_66, i64 0
  %_67 = srem i64 %.4.i, 2
  %_68 = add nsw i64 %.4.i, %_67
  br label %_69

_69:                                              ; preds = %_65, %_64
  %.5.i = phi i64 [ %_68, %_65 ], [ %.2.i, %_64 ]
