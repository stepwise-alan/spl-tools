; ModuleID = '/tmp/sea-af3phaga/25.pp.ms.o.bc'
...
entry:
  ...
  %_45 = call i1 @nondet.bool()
  call void @verifier.assume.not(i1 %_45)
  br label %precall
...
sortcmp:                                          ; preds = %precall
  call void @seahorn.fn.enter() #7
  br i1 %_13, label %_46, label %_49

_46:                                              ; preds = %sortcmp
  %_47 = add nsw i64 %_1, %_0
  %_48 = sub nsw i64 %_1, %_0
  br label %_75

_49:                                              ; preds = %sortcmp
  br i1 %_14, label %_50, label %_53

_50:                                              ; preds = %_49
  %_51 = add nsw i64 %_3, %_2
  %_52 = sub nsw i64 %_3, %_2
  br label %_75

_53:                                              ; preds = %_49
  br i1 %_15, label %_54, label %_57

_54:                                              ; preds = %_53
  %_55 = add nsw i64 %_5, %_4
  %_56 = sub nsw i64 %_5, %_4
  br label %_75

_57:                                              ; preds = %_53
  br i1 %_16, label %_58, label %_61
...
_61:                                              ; preds = %_57
  br i1 %_17, label %_62, label %_75

_62:                                              ; preds = %_61
  %_63 = and i32 %_9, 61440
  %_64 = icmp eq i32 %_63, 16384
  %_65 = zext i1 %_64 to i64
  %_66 = and i32 %_8, 61440
  %_67 = icmp eq i32 %_66, 16384
  %.neg.i = sext i1 %_67 to i64
  %_68 = add nsw i64 %.neg.i, %_65
  %_69 = and i32 %_9, 61440
  %_70 = icmp eq i32 %_69, 16384
  %_71 = zext i1 %_70 to i64
  %_72 = and i32 %_8, 61440
  %_73 = icmp eq i32 %_72, 16384
  %.neg8.i = sext i1 %_73 to i64
  %_74 = add nsw i64 %.neg8.i, %_71
  br label %_75

_75:                                              ; preds = %_62, %_61, %_58, %_54, %_50, %_46
  %.01.i = phi i64 [ %_47, %_46 ], [ %_51, %_50 ], [ %_55, %_54 ], [ %_59, %_58 ], [ %_68, %_62 ], [ 0, %_61 ]
  %.0.i = phi i64 [ %_48, %_46 ], [ %_52, %_50 ], [ %_56, %_54 ], [ %_60, %_58 ], [ %_74, %_62 ], [ 0, %_61 ]
  %_76 = icmp eq i64 %.01.i, 0
  %spec.select12.v.i = select i1 %_19, i32 %_10, i32 %_11
  %spec.select12.i = sext i32 %spec.select12.v.i to i64
  %.23.i = select i1 %_76, i64 %spec.select12.i, i64 %.01.i
  %_77 = icmp eq i64 %.0.i, 0
  %spec.select13.v.i = select i1 %_19, i32 %_10, i32 %_11
  %spec.select13.i = sext i32 %spec.select13.v.i to i64
  %.2.i = select i1 %_77, i64 %spec.select13.i, i64 %.0.i
  %.not.i = icmp eq i64 %.23.i, 0
  br i1 %.not.i, label %_81, label %_78

_78:                                              ; preds = %_75
  %.45.i = ashr i64 %.23.i, 32
  %_79 = srem i64 %.45.i, 2
  %_80 = add nsw i64 %.45.i, %_79
  br label %_81

_81:                                              ; preds = %_78, %_75
  %.56.i = phi i64 [ %_80, %_78 ], [ %.23.i, %_75 ]
  %.not7.i = icmp eq i64 %.2.i, 0
  br i1 %.not7.i, label %_86, label %_82

_82:                                              ; preds = %_81
  %_83 = ashr i64 %.2.i, 32
  %.4.i = select i1 %_20, i64 %_83, i64 0
  %_84 = srem i64 %.4.i, 2
  %_85 = add nsw i64 %.4.i, %_84
  br label %_86

_86:                                              ; preds = %_82, %_81
  %.5.i = phi i64 [ %_85, %_82 ], [ %.2.i, %_81 ]
  %_87 = trunc i64 %.56.i to i32
  %_88 = sub nsw i32 0, %_87
  %_89 = trunc i64 %.56.i to i32
  %_90 = select i1 %_18, i32 %_88, i32 %_89
  %_91 = trunc i64 %.5.i to i32
  %_92 = sub nsw i32 0, %_91
  %_93 = trunc i64 %.5.i to i32
  %_94 = select i1 %_18, i32 %_92, i32 %_93
  %_95 = icmp eq i32 %_90, %_94
  call void @verifier.assume.not(i1 %_95)
  br label %_96

_96:                                              ; preds = %_86
  br label %verifier.error

verifier.error:                                   ; preds = %_96
