; ModuleID = '/tmp/sea-6_dkb69m/13.pp.ms.o.bc'
...
sortcmp:                                          ; preds = %precall
  call void @seahorn.fn.enter() #7
  br i1 %_13, label %_34, label %_37

_34:                                              ; preds = %sortcmp
  %_35 = add nsw i64 %_1, %_0
  %_36 = sub nsw i64 %_1, %_0
  br label %_63

_37:                                              ; preds = %sortcmp
  br i1 %_14, label %_38, label %_41

_38:                                              ; preds = %_37
  %_39 = add nsw i64 %_3, %_2
  %_40 = sub nsw i64 %_3, %_2
  br label %_63

_41:                                              ; preds = %_37
  br i1 %_15, label %_42, label %_45

_42:                                              ; preds = %_41
  %_43 = add nsw i64 %_5, %_4
  %_44 = sub nsw i64 %_5, %_4
  br label %_63

_45:                                              ; preds = %_41
  br i1 %_16, label %_46, label %_49
...
_50:                                              ; preds = %_49
  ...
  %.neg8.i = sext i1 %_61 to i64
  %_62 = add nsw i64 %.neg8.i, %_59
  br label %_63

_63:                                              ; preds = %_50, %_49, %_46, %_42, %_38, %_34
  %.01.i = phi i64 [ %_35, %_34 ], [ %_39, %_38 ], [ %_43, %_42 ], [ %_47, %_46 ], [ %_56, %_50 ], [ 0, %_49 ]
  %.0.i = phi i64 [ %_36, %_34 ], [ %_40, %_38 ], [ %_44, %_42 ], [ %_48, %_46 ], [ %_62, %_50 ], [ 0, %_49 ]
  %_64 = icmp eq i64 %.01.i, 0
  %spec.select12.v.i = select i1 %_19, i32 %_10, i32 %_11
  %spec.select12.i = sext i32 %spec.select12.v.i to i64
  %.23.i = select i1 %_64, i64 %spec.select12.i, i64 %.01.i
  %_65 = icmp eq i64 %.0.i, 0
  %spec.select13.v.i = select i1 %_19, i32 %_10, i32 %_11
  %spec.select13.i = sext i32 %spec.select13.v.i to i64
  %.2.i = select i1 %_65, i64 %spec.select13.i, i64 %.0.i
  %.not.i = icmp eq i64 %.23.i, 0
  br i1 %.not.i, label %_69, label %_66

_66:                                              ; preds = %_63
  %.45.i = ashr i64 %.23.i, 32
  %_67 = srem i64 %.45.i, 2
  %_68 = add nsw i64 %.45.i, %_67
  br label %_69

_69:                                              ; preds = %_66, %_63
  %.56.i = phi i64 [ %_68, %_66 ], [ %.23.i, %_63 ]
  %.not7.i = icmp eq i64 %.2.i, 0
  br i1 %.not7.i, label %_74, label %_70

_70:                                              ; preds = %_69
  %_71 = ashr i64 %.2.i, 32
  %.4.i = select i1 %_20, i64 %_71, i64 0
  %_72 = srem i64 %.4.i, 2
  %_73 = add nsw i64 %.4.i, %_72
  br label %_74

_74:                                              ; preds = %_70, %_69
  %.5.i = phi i64 [ %_73, %_70 ], [ %.2.i, %_69 ]
