; ModuleID = '/tmp/sea-rbldjvpd/11.pp.ms.o.bc'
...
sortcmp:                                          ; preds = %precall
  call void @seahorn.fn.enter() #7
  br i1 %_13, label %_32, label %_35

_32:                                              ; preds = %sortcmp
  %_33 = add nsw i64 %_1, %_0
  %_34 = sub nsw i64 %_1, %_0
  br label %_61

_35:                                              ; preds = %sortcmp
  br i1 %_14, label %_36, label %_39

_36:                                              ; preds = %_35
  %_37 = add nsw i64 %_3, %_2
  %_38 = sub nsw i64 %_3, %_2
  br label %_61

_39:                                              ; preds = %_35
  br i1 %_15, label %_40, label %_43
...
_48:                                              ; preds = %_47
  ...
  %.neg8.i = sext i1 %_59 to i64
  %_60 = add nsw i64 %.neg8.i, %_57
  br label %_61

_61:                                              ; preds = %_48, %_47, %_44, %_40, %_36, %_32
  %.01.i = phi i64 [ %_33, %_32 ], [ %_37, %_36 ], [ %_41, %_40 ], [ %_45, %_44 ], [ %_54, %_48 ], [ 0, %_47 ]
  %.0.i = phi i64 [ %_34, %_32 ], [ %_38, %_36 ], [ %_42, %_40 ], [ %_46, %_44 ], [ %_60, %_48 ], [ 0, %_47 ]
  %_62 = icmp eq i64 %.01.i, 0
  %spec.select12.v.i = select i1 %_19, i32 %_10, i32 %_11
  %spec.select12.i = sext i32 %spec.select12.v.i to i64
  %.23.i = select i1 %_62, i64 %spec.select12.i, i64 %.01.i
  %_63 = icmp eq i64 %.0.i, 0
  %spec.select13.v.i = select i1 %_19, i32 %_10, i32 %_11
  %spec.select13.i = sext i32 %spec.select13.v.i to i64
  %.2.i = select i1 %_63, i64 %spec.select13.i, i64 %.0.i
  %.not.i = icmp eq i64 %.23.i, 0
  br i1 %.not.i, label %_67, label %_64

_64:                                              ; preds = %_61
  %.45.i = ashr i64 %.23.i, 32
  %_65 = srem i64 %.45.i, 2
  %_66 = add nsw i64 %.45.i, %_65
  br label %_67

_67:                                              ; preds = %_64, %_61
  %.56.i = phi i64 [ %_66, %_64 ], [ %.23.i, %_61 ]
  %.not7.i = icmp eq i64 %.2.i, 0
  br i1 %.not7.i, label %_72, label %_68

_68:                                              ; preds = %_67
  %_69 = ashr i64 %.2.i, 32
  %.4.i = select i1 %_20, i64 %_69, i64 0
  %_70 = srem i64 %.4.i, 2
  %_71 = add nsw i64 %.4.i, %_70
  br label %_72

_72:                                              ; preds = %_68, %_67
  %.5.i = phi i64 [ %_71, %_68 ], [ %.2.i, %_67 ]
  %_73 = trunc i64 %.56.i to i32
  %_74 = sub nsw i32 0, %_73
  %_75 = trunc i64 %.56.i to i32
