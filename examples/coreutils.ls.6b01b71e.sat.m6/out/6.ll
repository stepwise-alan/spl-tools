; ModuleID = '/tmp/sea-13zc7xp5/6.pp.ms.o.bc'
source_filename = "6.c"
...
entry:
  ...
  %_26 = call i1 @nondet.bool()
  call void @verifier.assume.not(i1 %_26)
  br label %precall
...
sortcmp:                                          ; preds = %precall
  call void @seahorn.fn.enter() #7
  br i1 %_13, label %_27, label %_30

_27:                                              ; preds = %sortcmp
  %_28 = add nsw i64 %_1, %_0
  %_29 = sub nsw i64 %_1, %_0
  br label %_56

_30:                                              ; preds = %sortcmp
  br i1 %_14, label %_31, label %_34

_31:                                              ; preds = %_30
  %_32 = add nsw i64 %_3, %_2
...
_56:                                              ; preds = %_43, %_42, %_39, %_35, %_31, %_27
  %.01.i = phi i64 [ %_28, %_27 ], [ %_32, %_31 ], [ %_36, %_35 ], [ %_40, %_39 ], [ %_49, %_43 ], [ 0, %_42 ]
  %.0.i = phi i64 [ %_29, %_27 ], [ %_33, %_31 ], [ %_37, %_35 ], [ %_41, %_39 ], [ %_55, %_43 ], [ 0, %_42 ]
...
_63:                                              ; preds = %_62
  %_64 = ashr i64 %.2.i, 32
  %.4.i = select i1 %_20, i64 %_64, i64 0
  %_65 = srem i64 %.4.i, 2
