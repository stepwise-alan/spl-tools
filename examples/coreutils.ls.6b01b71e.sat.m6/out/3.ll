; ModuleID = '/tmp/sea-185h3m9c/3.pp.ms.o.bc'
source_filename = "3.c"
...
entry:
  ...
  %_23 = call i1 @nondet.bool()
  call void @verifier.assume.not(i1 %_23)
  br label %precall
...
sortcmp:                                          ; preds = %precall
  call void @seahorn.fn.enter() #7
  br i1 %_13, label %_24, label %_27

_24:                                              ; preds = %sortcmp
  %_25 = add nsw i64 %_1, %_0
  %_26 = sub nsw i64 %_1, %_0
  br label %_53

_27:                                              ; preds = %sortcmp
  br i1 %_14, label %_28, label %_31

_28:                                              ; preds = %_27
  %_29 = add nsw i64 %_3, %_2
  %_30 = sub nsw i64 %_3, %_2
  br label %_53

_31:                                              ; preds = %_27
  br i1 %_15, label %_32, label %_35

_32:                                              ; preds = %_31
  %_33 = add nsw i64 %_5, %_4
  %_34 = sub nsw i64 %_5, %_4
  br label %_53

_35:                                              ; preds = %_31
  br i1 %_16, label %_36, label %_39

_36:                                              ; preds = %_35
  %_37 = sub nsw i64 %_7, %_6
  %_38 = sub nsw i64 %_7, %_6
  br label %_53

_39:                                              ; preds = %_35
  br i1 %_17, label %_40, label %_53

_40:                                              ; preds = %_39
  %_41 = and i32 %_9, 61440
  %_42 = icmp eq i32 %_41, 16384
  %_43 = zext i1 %_42 to i64
  %_44 = and i32 %_8, 61440
  %_45 = icmp eq i32 %_44, 16384
  %.neg.i = sext i1 %_45 to i64
  %_46 = add nsw i64 %.neg.i, %_43
  %_47 = and i32 %_9, 61440
  %_48 = icmp eq i32 %_47, 16384
  %_49 = zext i1 %_48 to i64
  %_50 = and i32 %_8, 61440
  %_51 = icmp eq i32 %_50, 16384
  %.neg8.i = sext i1 %_51 to i64
  %_52 = add nsw i64 %.neg8.i, %_49
  br label %_53

_53:                                              ; preds = %_40, %_39, %_36, %_32, %_28, %_24
  %.01.i = phi i64 [ %_25, %_24 ], [ %_29, %_28 ], [ %_33, %_32 ], [ %_37, %_36 ], [ %_46, %_40 ], [ 0, %_39 ]
  %.0.i = phi i64 [ %_26, %_24 ], [ %_30, %_28 ], [ %_34, %_32 ], [ %_38, %_36 ], [ %_52, %_40 ], [ 0, %_39 ]
  %_54 = icmp eq i64 %.01.i, 0
  %spec.select12.v.i = select i1 %_19, i32 %_10, i32 %_11
  %spec.select12.i = sext i32 %spec.select12.v.i to i64
  %.23.i = select i1 %_54, i64 %spec.select12.i, i64 %.01.i
  %_55 = icmp eq i64 %.0.i, 0
  %spec.select13.v.i = select i1 %_19, i32 %_10, i32 %_11
  %spec.select13.i = sext i32 %spec.select13.v.i to i64
  %.2.i = select i1 %_55, i64 %spec.select13.i, i64 %.0.i
  %.not.i = icmp eq i64 %.23.i, 0
  br i1 %.not.i, label %_59, label %_56

_56:                                              ; preds = %_53
  %.45.i = ashr i64 %.23.i, 32
  %_57 = srem i64 %.45.i, 2
  %_58 = add nsw i64 %.45.i, %_57
  br label %_59

_59:                                              ; preds = %_56, %_53
  %.56.i = phi i64 [ %_58, %_56 ], [ %.23.i, %_53 ]
  %.not7.i = icmp eq i64 %.2.i, 0
  br i1 %.not7.i, label %_64, label %_60

_60:                                              ; preds = %_59
  %_61 = ashr i64 %.2.i, 32
  %.4.i = select i1 %_20, i64 %_61, i64 0
  %_62 = srem i64 %.4.i, 2
  %_63 = add nsw i64 %.4.i, %_62
  br label %_64

_64:                                              ; preds = %_60, %_59
  %.5.i = phi i64 [ %_63, %_60 ], [ %.2.i, %_59 ]
  %_65 = trunc i64 %.56.i to i32
  %_66 = sub nsw i32 0, %_65
  %_67 = trunc i64 %.56.i to i32
  %_68 = select i1 %_18, i32 %_66, i32 %_67
  %_69 = trunc i64 %.5.i to i32
  %_70 = sub nsw i32 0, %_69
  %_71 = trunc i64 %.5.i to i32
  %_72 = select i1 %_18, i32 %_70, i32 %_71
  %_73 = icmp eq i32 %_68, %_72
  call void @verifier.assume.not(i1 %_73)
  br label %_74

_74:                                              ; preds = %_64
  br label %verifier.error

verifier.error:                                   ; preds = %_74
