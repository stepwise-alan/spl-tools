; ModuleID = '/tmp/sea-24o43gv5/22.pp.ms.o.bc'
...
sortcmp:                                          ; preds = %precall
  call void @seahorn.fn.enter() #7
  br i1 %_13, label %_43, label %_46

_43:                                              ; preds = %sortcmp
  %_44 = add nsw i64 %_1, %_0
  %_45 = sub nsw i64 %_1, %_0
  br label %_72

_46:                                              ; preds = %sortcmp
  br i1 %_14, label %_47, label %_50

_47:                                              ; preds = %_46
  %_48 = add nsw i64 %_3, %_2
  %_49 = sub nsw i64 %_3, %_2
  br label %_72

_50:                                              ; preds = %_46
  br i1 %_15, label %_51, label %_54

_51:                                              ; preds = %_50
  %_52 = add nsw i64 %_5, %_4
  %_53 = sub nsw i64 %_5, %_4
  br label %_72

_54:                                              ; preds = %_50
  br i1 %_16, label %_55, label %_58
...
_59:                                              ; preds = %_58
  ...
  %.neg.i = sext i1 %_64 to i64
  %_65 = add nsw i64 %.neg.i, %_62
  %_66 = and i32 %_9, 61440
  %_67 = icmp eq i32 %_66, 16384
  %_68 = zext i1 %_67 to i64
  %_69 = and i32 %_8, 61440
  %_70 = icmp eq i32 %_69, 16384
  %.neg8.i = sext i1 %_70 to i64
  %_71 = add nsw i64 %.neg8.i, %_68
  br label %_72

_72:                                              ; preds = %_59, %_58, %_55, %_51, %_47, %_43
  %.01.i = phi i64 [ %_44, %_43 ], [ %_48, %_47 ], [ %_52, %_51 ], [ %_56, %_55 ], [ %_65, %_59 ], [ 0, %_58 ]
  %.0.i = phi i64 [ %_45, %_43 ], [ %_49, %_47 ], [ %_53, %_51 ], [ %_57, %_55 ], [ %_71, %_59 ], [ 0, %_58 ]
  %_73 = icmp eq i64 %.01.i, 0
  %spec.select12.v.i = select i1 %_19, i32 %_10, i32 %_11
  %spec.select12.i = sext i32 %spec.select12.v.i to i64
  %.23.i = select i1 %_73, i64 %spec.select12.i, i64 %.01.i
  %_74 = icmp eq i64 %.0.i, 0
  %spec.select13.v.i = select i1 %_19, i32 %_10, i32 %_11
  %spec.select13.i = sext i32 %spec.select13.v.i to i64
  %.2.i = select i1 %_74, i64 %spec.select13.i, i64 %.0.i
  %.not.i = icmp eq i64 %.23.i, 0
  br i1 %.not.i, label %_78, label %_75

_75:                                              ; preds = %_72
  %.45.i = ashr i64 %.23.i, 32
  %_76 = srem i64 %.45.i, 2
  %_77 = add nsw i64 %.45.i, %_76
  br label %_78

_78:                                              ; preds = %_75, %_72
  %.56.i = phi i64 [ %_77, %_75 ], [ %.23.i, %_72 ]
  %.not7.i = icmp eq i64 %.2.i, 0
  br i1 %.not7.i, label %_83, label %_79

_79:                                              ; preds = %_78
  %_80 = ashr i64 %.2.i, 32
  %.4.i = select i1 %_20, i64 %_80, i64 0
  %_81 = srem i64 %.4.i, 2
  %_82 = add nsw i64 %.4.i, %_81
  br label %_83

_83:                                              ; preds = %_79, %_78
  %.5.i = phi i64 [ %_82, %_79 ], [ %.2.i, %_78 ]
  ...
  %_92 = icmp eq i32 %_87, %_91
  call void @verifier.assume.not(i1 %_92)
  br label %_93

_93:                                              ; preds = %_83
  br label %verifier.error

verifier.error:                                   ; preds = %_93
