; ModuleID = '/tmp/sea-aozx18cj/4.pp.ms.o.bc'
source_filename = "4.c"
...
sortcmp:                                          ; preds = %precall
  call void @seahorn.fn.enter() #7
  br i1 %_13, label %_25, label %_28

_25:                                              ; preds = %sortcmp
  %_26 = add nsw i64 %_1, %_0
  %_27 = sub nsw i64 %_1, %_0
  br label %_54

_28:                                              ; preds = %sortcmp
  br i1 %_14, label %_29, label %_32

_29:                                              ; preds = %_28
  %_30 = add nsw i64 %_3, %_2
  %_31 = sub nsw i64 %_3, %_2
  br label %_54

_32:                                              ; preds = %_28
  br i1 %_15, label %_33, label %_36

_33:                                              ; preds = %_32
  %_34 = add nsw i64 %_5, %_4
  %_35 = sub nsw i64 %_5, %_4
  br label %_54

_36:                                              ; preds = %_32
  br i1 %_16, label %_37, label %_40
...
_41:                                              ; preds = %_40
  ...
  %.neg8.i = sext i1 %_52 to i64
  %_53 = add nsw i64 %.neg8.i, %_50
  br label %_54

_54:                                              ; preds = %_41, %_40, %_37, %_33, %_29, %_25
  %.01.i = phi i64 [ %_26, %_25 ], [ %_30, %_29 ], [ %_34, %_33 ], [ %_38, %_37 ], [ %_47, %_41 ], [ 0, %_40 ]
  %.0.i = phi i64 [ %_27, %_25 ], [ %_31, %_29 ], [ %_35, %_33 ], [ %_39, %_37 ], [ %_53, %_41 ], [ 0, %_40 ]
  %_55 = icmp eq i64 %.01.i, 0
  %spec.select12.v.i = select i1 %_19, i32 %_10, i32 %_11
  %spec.select12.i = sext i32 %spec.select12.v.i to i64
  %.23.i = select i1 %_55, i64 %spec.select12.i, i64 %.01.i
  %_56 = icmp eq i64 %.0.i, 0
  %spec.select13.v.i = select i1 %_19, i32 %_10, i32 %_11
  %spec.select13.i = sext i32 %spec.select13.v.i to i64
  %.2.i = select i1 %_56, i64 %spec.select13.i, i64 %.0.i
  %.not.i = icmp eq i64 %.23.i, 0
  br i1 %.not.i, label %_60, label %_57

_57:                                              ; preds = %_54
  %.45.i = ashr i64 %.23.i, 32
  %_58 = srem i64 %.45.i, 2
  %_59 = add nsw i64 %.45.i, %_58
  br label %_60

_60:                                              ; preds = %_57, %_54
  %.56.i = phi i64 [ %_59, %_57 ], [ %.23.i, %_54 ]
  %.not7.i = icmp eq i64 %.2.i, 0
  br i1 %.not7.i, label %_65, label %_61

_61:                                              ; preds = %_60
  %_62 = ashr i64 %.2.i, 32
  %.4.i = select i1 %_20, i64 %_62, i64 0
  %_63 = srem i64 %.4.i, 2
  %_64 = add nsw i64 %.4.i, %_63
  br label %_65

_65:                                              ; preds = %_61, %_60
  %.5.i = phi i64 [ %_64, %_61 ], [ %.2.i, %_60 ]
