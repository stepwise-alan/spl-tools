; ModuleID = '/tmp/sea-e15kknnc/1.pp.ms.o.bc'
source_filename = "1.c"
...
_27:                                              ; preds = %_24
  br i1 %_15, label %_28, label %_31

_28:                                              ; preds = %_27
  %_29 = sub nsw i64 %_5, %_4
  %_30 = add nsw i64 %_5, %_4
  br label %_49

_31:                                              ; preds = %_27
  br i1 %_16, label %_32, label %_35
...
_35:                                              ; preds = %_31
  br i1 %_17, label %_36, label %_49

_36:                                              ; preds = %_35
  %_37 = and i32 %_9, 61440
  %_38 = icmp eq i32 %_37, 16384
  %_39 = zext i1 %_38 to i64
  %_40 = and i32 %_8, 61440
  %_41 = icmp eq i32 %_40, 16384
  %.neg.i = sext i1 %_41 to i64
  %_42 = add nsw i64 %.neg.i, %_39
  %_43 = and i32 %_9, 61440
  %_44 = icmp eq i32 %_43, 16384
  %_45 = zext i1 %_44 to i64
  %_46 = and i32 %_8, 61440
  %_47 = icmp eq i32 %_46, 16384
  %.neg8.i = sext i1 %_47 to i64
  %_48 = add nsw i64 %.neg8.i, %_45
  br label %_49

_49:                                              ; preds = %_36, %_35, %_32, %_28, %_25, %_22
  %.01.i = phi i64 [ %_23, %_22 ], [ %_26, %_25 ], [ %_29, %_28 ], [ %_33, %_32 ], [ %_42, %_36 ], [ 0, %_35 ]
  %.0.i = phi i64 [ %_23, %_22 ], [ %_26, %_25 ], [ %_30, %_28 ], [ %_34, %_32 ], [ %_48, %_36 ], [ 0, %_35 ]
  %_50 = icmp eq i64 %.01.i, 0
  %spec.select12.v.i = select i1 %_19, i32 %_10, i32 %_11
  %spec.select12.i = sext i32 %spec.select12.v.i to i64
  %.23.i = select i1 %_50, i64 %spec.select12.i, i64 %.01.i
  %_51 = icmp eq i64 %.0.i, 0
  %spec.select13.v.i = select i1 %_19, i32 %_10, i32 %_11
  %spec.select13.i = sext i32 %spec.select13.v.i to i64
  %.2.i = select i1 %_51, i64 %spec.select13.i, i64 %.0.i
  %.not.i = icmp eq i64 %.23.i, 0
  br i1 %.not.i, label %_55, label %_52

_52:                                              ; preds = %_49
  %.45.i = ashr i64 %.23.i, 32
  %_53 = srem i64 %.45.i, 2
  %_54 = add nsw i64 %.45.i, %_53
  br label %_55

_55:                                              ; preds = %_52, %_49
  %.56.i = phi i64 [ %_54, %_52 ], [ %.23.i, %_49 ]
  %.not7.i = icmp eq i64 %.2.i, 0
  br i1 %.not7.i, label %_60, label %_56

_56:                                              ; preds = %_55
  %_57 = ashr i64 %.2.i, 32
  %.4.i = select i1 %_20, i64 0, i64 %_57
  %_58 = srem i64 %.4.i, 2
  %_59 = add nsw i64 %.4.i, %_58
  br label %_60

_60:                                              ; preds = %_56, %_55
  %.5.i = phi i64 [ %_59, %_56 ], [ %.2.i, %_55 ]
  %_61 = trunc i64 %.56.i to i32
  %_62 = sub nsw i32 0, %_61
  %_63 = trunc i64 %.56.i to i32
  %_64 = select i1 %_18, i32 %_62, i32 %_63
  %_65 = trunc i64 %.5.i to i32
  %_66 = sub nsw i32 0, %_65
  %_67 = trunc i64 %.5.i to i32
  %_68 = select i1 %_18, i32 %_66, i32 %_67
  %_69 = icmp eq i32 %_64, %_68
  call void @verifier.assume.not(i1 %_69)
  br label %_70

_70:                                              ; preds = %_60
  br label %verifier.error

verifier.error:                                   ; preds = %_70
