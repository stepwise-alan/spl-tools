  ...
  if ((sizeof(off_t ) > sizeof(int ))) {
    if ((sizeof(off_t ) == (sizeof(int ) * 2))) {
      ...
      while (((dif & (~ ((off_t ) 2147483647))) != 0)) {
        ...
        #if (definedEx(F3) && definedEx(F19) && definedEx(F8) && !definedEx(F11) && !definedEx(F33) && definedEx(F38) && !definedEx(F23) && definedEx(F21) && definedEx(F9) && !definedEx(F15) && !definedEx(F36) && definedEx(F0))
        (dif >>= (sizeof(int ) * 8 / 2));
        #endif
