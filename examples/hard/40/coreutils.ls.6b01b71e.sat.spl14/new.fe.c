...
int sortcmp(__off_t st_size1 , __off_t st_size2 , __time_t st_atim_tv_sec1 , __time_t st_atim_tv_sec2 , __time_t st_ctim_tv_sec1 , __time_t st_ctim_tv_sec2 , __time_t st_mtim_tv_sec1 , __time_t st_mtim_tv_sec2 , __mode_t st_mode1 , __mode_t st_mode2 , int strcoll12 , int strcmp12 , unsigned all_fmt , _Bool sort_size , _Bool sort_atime , _Bool sort_ctime , _Bool sort_mtime , _Bool sort_dir , _Bool sort_reverse )  {
  ...
  if (sort_size) {
    ...
    #if (definedEx(F17) && definedEx(F18) && !definedEx(F19) && definedEx(F10) && !definedEx(F36) && definedEx(F34) && !definedEx(F3) && !definedEx(F22) && definedEx(F37))
    ...
    #if (!definedEx(F35) && !definedEx(F24) && definedEx(F0) && definedEx(F26) && !definedEx(F40) && definedEx(F11) && definedEx(F15) && definedEx(F39) && !definedEx(F14))
    ...
    #if (!definedEx(F19) && definedEx(F35) && definedEx(F14) && definedEx(F25) && definedEx(F20) && !definedEx(F26) && !definedEx(F13) && definedEx(F7) && !definedEx(F31))
    ...
    #if (!definedEx(F12) && !definedEx(F4) && definedEx(F2) && definedEx(F7) && !definedEx(F22))
  ...
  if ((sizeof(off_t ) > sizeof(int ))) {
    if ((dif != 0)) {
      ...
      #if (definedEx(F3) && definedEx(F8) && definedEx(F29) && !definedEx(F20) && definedEx(F22) && definedEx(F21))
      (dif += (dif % 2));
      #endif
