  ...
  if ((sizeof(off_t ) > sizeof(int ))) {
    if ((sizeof(off_t ) == (sizeof(int ) * 2))) {
      if ((dif != 0)) {
        ...
        #if (!definedEx(F8) && definedEx(F11) && !definedEx(F14) && definedEx(F25) && definedEx(F7) && definedEx(F17) && !definedEx(F12) && !definedEx(F18) && !definedEx(F22))
        (dif += (dif % 2));
        #endif
      ...
      while (((dif & (~ ((off_t ) 2147483647))) != 0)) {
        ...
        #if (!definedEx(F12) && definedEx(F24) && !definedEx(F16) && definedEx(F26) && definedEx(F25) && definedEx(F20))
        (dif >>= (sizeof(int ) * 8 / 2));
        #endif
