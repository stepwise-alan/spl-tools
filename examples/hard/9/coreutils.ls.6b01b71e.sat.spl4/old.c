  ...
  if ((sizeof(off_t ) > sizeof(int ))) {
    if ((sizeof(off_t ) == (sizeof(int ) * 2))) {
      if ((dif != 0)) {
        ...
        #if (definedEx(F3) && definedEx(F8) && !definedEx(F7) && definedEx(F0) && definedEx(F5) && definedEx(F4) && definedEx(F6) && definedEx(F1) && !definedEx(F2))
        (dif += (dif % 2));
        #endif
      ...
      while (((dif & (~ ((off_t ) 2147483647))) != 0)) {
        ...
        #if (definedEx(F3) && !definedEx(F6) && definedEx(F8) && definedEx(F9) && definedEx(F5) && definedEx(F2) && definedEx(F4) && definedEx(F7))
        (dif >>= (sizeof(int ) * 8 / 2));
        #endif
