  ...
  if ((sizeof(off_t ) > sizeof(int ))) {
    if ((sizeof(off_t ) == (sizeof(int ) * 2))) {
      if ((dif != 0)) {
        ...
        #if (definedEx(F12) && !definedEx(F2) && definedEx(F20) && definedEx(F7) && !definedEx(F9) && !definedEx(F3) && !definedEx(F17) && !definedEx(F13) && definedEx(F6))
        (dif += (dif % 2));
        #endif
      ...
      while (((dif & (~ ((off_t ) 2147483647))) != 0)) {
        ...
        #if (definedEx(F18) && definedEx(F19) && definedEx(F10) && definedEx(F14) && definedEx(F20) && definedEx(F6))
        (dif >>= (sizeof(int ) * 8 / 2));
        #endif
