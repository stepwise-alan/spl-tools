; ModuleID = '/tmp/sea-6tenqrcf/4.pp.ms.o.bc'
source_filename = "4.c"
...
_46:                                              ; preds = %_44
  %_47 = shl i64 %.2.i, 16
  %_48 = ashr i64 %_47, 32
  %.35.i = select i1 %_20, i64 %_48, i64 %.2.i
  %_49 = shl i64 %.35.i, 16
  %_50 = ashr i64 %_49, 32
  %.46.i = select i1 %_20, i64 %_48, i64 %_50
  %_51 = srem i64 %.46.i, 2
  %_52 = add nsw i64 %.46.i, %_51
  br label %_53

_53:                                              ; preds = %_46, %_44
  %.57.i = phi i64 [ %_52, %_46 ], [ %.2.i, %_44 ]
