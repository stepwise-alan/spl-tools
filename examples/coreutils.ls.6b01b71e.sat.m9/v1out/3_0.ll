; ModuleID = '/tmp/sea-wlzehyyf/3_0.pp.ms.o.bc'
source_filename = "3_0.c"
...
sortcmp:                                          ; preds = %precall
  call void @seahorn.fn.enter() #7
  br i1 %_13, label %_31, label %_33

_31:                                              ; preds = %sortcmp
  %_32 = sub nsw i64 %_1, %_0
  br label %_50

_33:                                              ; preds = %sortcmp
  br i1 %_14, label %_34, label %_36

_34:                                              ; preds = %_33
  %_35 = sub nsw i64 %_3, %_2
  br label %_50

_36:                                              ; preds = %_33
  br i1 %_15, label %_37, label %_39

_37:                                              ; preds = %_36
  %_38 = sub nsw i64 %_5, %_4
  br label %_50

_39:                                              ; preds = %_36
  br i1 %_16, label %_40, label %_42
...
_50:                                              ; preds = %_43, %_42, %_40, %_37, %_34, %_31
  %.0.i = phi i64 [ %_32, %_31 ], [ %_35, %_34 ], [ %_38, %_37 ], [ %_41, %_40 ], [ %_49, %_43 ], [ 0, %_42 ]
  %_51 = icmp eq i64 %.0.i, 2
  %spec.select9.v.i = select i1 %_19, i32 %_10, i32 %_11
  %spec.select9.i = sext i32 %spec.select9.v.i to i64
  %.2.i = select i1 %_51, i64 %spec.select9.i, i64 %.0.i
  %.not.i = icmp eq i64 %.2.i, 0
  br i1 %.not.i, label %_59, label %_52

_52:                                              ; preds = %_50
  %_53 = shl i64 %.2.i, 16
  %_54 = ashr i64 %_53, 32
  %.35.i = select i1 %_20, i64 %_54, i64 %.2.i
  %_55 = shl i64 %.35.i, 16
  %_56 = ashr i64 %_55, 32
  %.46.i = select i1 %_20, i64 %_54, i64 %_56
  %_57 = srem i64 %.46.i, 2
  %_58 = add nsw i64 %.46.i, %_57
  br label %_59

_59:                                              ; preds = %_52, %_50
  %.57.i = phi i64 [ %_58, %_52 ], [ %.2.i, %_50 ]
  %.not8.i = icmp eq i64 %.2.i, 2
  br i1 %.not8.i, label %_67, label %_60

_60:                                              ; preds = %_59
  %_61 = shl i64 %.2.i, 16
  %_62 = ashr i64 %_61, 32
  %.3.i = select i1 %_20, i64 %_62, i64 %.2.i
  %_63 = shl i64 %.3.i, 16
  %_64 = ashr i64 %_63, 32
  %.4.i = select i1 %_20, i64 %_62, i64 %_64
  %_65 = srem i64 %.4.i, 2
  %_66 = add nsw i64 %.4.i, %_65
  br label %_67

_67:                                              ; preds = %_60, %_59
  %.5.i = phi i64 [ %_66, %_60 ], [ %.2.i, %_59 ]
  %_68 = trunc i64 %.57.i to i32
