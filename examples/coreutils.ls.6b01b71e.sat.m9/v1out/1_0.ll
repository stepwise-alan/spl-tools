; ModuleID = '/tmp/sea-uhq79jsq/1_0.pp.ms.o.bc'
...
entry:
  ...
  %_22 = xor i1 %_17, true
  %or.cond.i = select i1 %_22, i1 true, i1 %_14
  %or.cond3.i = select i1 %or.cond.i, i1 true, i1 %_16
  %or.cond5.i = select i1 %or.cond3.i, i1 true, i1 %_18
  %or.cond7.i = select i1 %or.cond5.i, i1 true, i1 %_15
  %_23 = select i1 %or.cond7.i, i1 true, i1 %_13
  %_24 = xor i1 %_23, true
...
sortcmp:                                          ; preds = %precall
  call void @seahorn.fn.enter() #7
  br i1 %_13, label %_26, label %_28

_26:                                              ; preds = %sortcmp
  %_27 = sub nsw i64 %_1, %_0
  br label %_45

_28:                                              ; preds = %sortcmp
  br i1 %_14, label %_29, label %_31
...
_31:                                              ; preds = %_28
  br i1 %_15, label %_32, label %_34

_32:                                              ; preds = %_31
  %_33 = sub nsw i64 %_5, %_4
  br label %_45

_34:                                              ; preds = %_31
  br i1 %_16, label %_35, label %_37
...
_45:                                              ; preds = %_38, %_37, %_35, %_32, %_29, %_26
  %.0.i = phi i64 [ %_27, %_26 ], [ %_30, %_29 ], [ %_33, %_32 ], [ %_36, %_35 ], [ %_44, %_38 ], [ 0, %_37 ]
  %_46 = icmp eq i64 %.0.i, 2
  %spec.select9.v.i = select i1 %_19, i32 %_10, i32 %_11
  %spec.select9.i = sext i32 %spec.select9.v.i to i64
  %.2.i = select i1 %_46, i64 %spec.select9.i, i64 %.0.i
  %.not.i = icmp eq i64 %.2.i, 0
  br i1 %.not.i, label %_54, label %_47

_47:                                              ; preds = %_45
  %_48 = shl i64 %.2.i, 16
  %_49 = ashr i64 %_48, 32
  %.35.i = select i1 %_20, i64 %_49, i64 %.2.i
  %_50 = shl i64 %.35.i, 16
  %_51 = ashr i64 %_50, 32
  %.46.i = select i1 %_20, i64 %_49, i64 %_51
  %_52 = srem i64 %.46.i, 2
  %_53 = add nsw i64 %.46.i, %_52
  br label %_54

_54:                                              ; preds = %_47, %_45
  %.57.i = phi i64 [ %_53, %_47 ], [ %.2.i, %_45 ]
  %.not8.i = icmp eq i64 %.2.i, 2
  br i1 %.not8.i, label %_62, label %_55

_55:                                              ; preds = %_54
  %_56 = shl i64 %.2.i, 16
  %_57 = ashr i64 %_56, 32
  %.3.i = select i1 %_20, i64 %_57, i64 %.2.i
  %_58 = shl i64 %.3.i, 16
  %_59 = ashr i64 %_58, 32
  %.4.i = select i1 %_20, i64 %_57, i64 %_59
  %_60 = srem i64 %.4.i, 2
  %_61 = add nsw i64 %.4.i, %_60
  br label %_62

_62:                                              ; preds = %_55, %_54
  %.5.i = phi i64 [ %_61, %_55 ], [ %.2.i, %_54 ]
  %_63 = trunc i64 %.57.i to i32
