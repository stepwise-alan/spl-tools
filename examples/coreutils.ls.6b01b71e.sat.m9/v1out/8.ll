; ModuleID = '/tmp/sea-1pj7dp20/8.pp.ms.o.bc'
source_filename = "8.c"
...
_50:                                              ; preds = %_48
  %_51 = shl i64 %.2.i, 16
  %_52 = ashr i64 %_51, 32
  %.35.i = select i1 %_20, i64 %_52, i64 %.2.i
  %_53 = shl i64 %.35.i, 16
  %_54 = ashr i64 %_53, 32
  %.46.i = select i1 %_20, i64 %_52, i64 %_54
  %_55 = srem i64 %.46.i, 2
  %_56 = add nsw i64 %.46.i, %_55
  br label %_57

_57:                                              ; preds = %_50, %_48
  %.57.i = phi i64 [ %_56, %_50 ], [ %.2.i, %_48 ]
...
_58:                                              ; preds = %_57
  %_59 = shl i64 %.2.i, 16
  %_60 = ashr i64 %_59, 32
  %.3.i = select i1 %_20, i64 %_60, i64 %.2.i
  %_61 = shl i64 %.3.i, 16
  %_62 = ashr i64 %_61, 32
  %.4.i = select i1 %_20, i64 %_60, i64 %_62
  %_63 = srem i64 %.4.i, 2
  %_64 = add nsw i64 %.4.i, %_63
  br label %_65

_65:                                              ; preds = %_58, %_57
  %.5.i = phi i64 [ %_64, %_58 ], [ %.2.i, %_57 ]
