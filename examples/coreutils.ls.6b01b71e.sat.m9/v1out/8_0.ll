; ModuleID = '/tmp/sea-7_xgs_52/8_0.pp.ms.o.bc'
source_filename = "8_0.c"
...
entry:
  ...
  %_29 = icmp ne i32 %_10, 2
  %not..i = xor i1 %_14, true
  %or.cond.i = select i1 %not..i, i1 true, i1 %_29
  %or.cond3.i = select i1 %or.cond.i, i1 true, i1 %_18
  %or.cond5.i = select i1 %or.cond3.i, i1 true, i1 %_13
  %_30 = icmp ne i32 %_11, 0
  %or.cond7.i = select i1 %or.cond5.i, i1 true, i1 %_30
  br i1 %or.cond7.i, label %orig.main.exit, label %_31

_31:                                              ; preds = %entry
  %_32 = add nsw i64 %_4, %_5
  %_33 = icmp eq i64 %_32, 2
  br label %orig.main.exit

orig.main.exit:                                   ; preds = %_31, %entry
  %_34 = phi i1 [ false, %entry ], [ %_33, %_31 ]
...
_38:                                              ; preds = %sortcmp
  br i1 %_14, label %_39, label %_41

_39:                                              ; preds = %_38
  %_40 = sub nsw i64 %_3, %_2
  br label %_55

_41:                                              ; preds = %_38
  br i1 %_15, label %_42, label %_44
...
_48:                                              ; preds = %_47
  ...
  %.neg.i = sext i1 %_53 to i64
  %_54 = add nsw i64 %.neg.i, %_51
  br label %_55

_55:                                              ; preds = %_48, %_47, %_45, %_42, %_39, %_36
  %.0.i = phi i64 [ %_37, %_36 ], [ %_40, %_39 ], [ %_43, %_42 ], [ %_46, %_45 ], [ %_54, %_48 ], [ 0, %_47 ]
  %_56 = icmp eq i64 %.0.i, 2
  %spec.select9.v.i = select i1 %_19, i32 %_10, i32 %_11
  %spec.select9.i = sext i32 %spec.select9.v.i to i64
  %.2.i = select i1 %_56, i64 %spec.select9.i, i64 %.0.i
  %.not.i = icmp eq i64 %.2.i, 0
  br i1 %.not.i, label %_64, label %_57

_57:                                              ; preds = %_55
  %_58 = shl i64 %.2.i, 16
  %_59 = ashr i64 %_58, 32
  %.35.i = select i1 %_20, i64 %_59, i64 %.2.i
  %_60 = shl i64 %.35.i, 16
  %_61 = ashr i64 %_60, 32
  %.46.i = select i1 %_20, i64 %_59, i64 %_61
  %_62 = srem i64 %.46.i, 2
  %_63 = add nsw i64 %.46.i, %_62
  br label %_64

_64:                                              ; preds = %_57, %_55
  %.57.i = phi i64 [ %_63, %_57 ], [ %.2.i, %_55 ]
  %.not8.i = icmp eq i64 %.2.i, 2
  br i1 %.not8.i, label %_72, label %_65

_65:                                              ; preds = %_64
  %_66 = shl i64 %.2.i, 16
  %_67 = ashr i64 %_66, 32
  %.3.i = select i1 %_20, i64 %_67, i64 %.2.i
  %_68 = shl i64 %.3.i, 16
  %_69 = ashr i64 %_68, 32
  %.4.i = select i1 %_20, i64 %_67, i64 %_69
  %_70 = srem i64 %.4.i, 2
  %_71 = add nsw i64 %.4.i, %_70
  br label %_72

_72:                                              ; preds = %_65, %_64
  %.5.i = phi i64 [ %_71, %_65 ], [ %.2.i, %_64 ]
  ...
  %_81 = icmp eq i32 %_76, %_80
  call void @verifier.assume.not(i1 %_81)
  br label %_82

_82:                                              ; preds = %_72
  br label %verifier.error

verifier.error:                                   ; preds = %_82
