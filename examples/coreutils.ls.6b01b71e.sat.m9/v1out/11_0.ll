; ModuleID = '/tmp/sea-pie7c5ax/11_0.pp.ms.o.bc'
source_filename = "11_0.c"
...
entry:
  ...
  %_32 = icmp ne i32 %_10, 2
  %not..i = xor i1 %_14, true
  %or.cond.i = select i1 %not..i, i1 true, i1 %_32
  %or.cond3.i = select i1 %or.cond.i, i1 true, i1 %_18
  %or.cond5.i = select i1 %or.cond3.i, i1 true, i1 %_13
  %_33 = icmp ne i32 %_11, 0
  %or.cond7.i = select i1 %or.cond5.i, i1 true, i1 %_33
  br i1 %or.cond7.i, label %orig.main.exit, label %_34

_34:                                              ; preds = %entry
  %_35 = add nsw i64 %_4, %_5
  %_36 = icmp eq i64 %_35, 2
  br label %orig.main.exit

orig.main.exit:                                   ; preds = %_34, %entry
  %_37 = phi i1 [ false, %entry ], [ %_36, %_34 ]
