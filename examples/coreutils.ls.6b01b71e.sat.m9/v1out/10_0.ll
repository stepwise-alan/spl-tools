; ModuleID = '/tmp/sea-buod7j9c/10_0.pp.ms.o.bc'
source_filename = "10_0.c"
...
entry:
  ...
  %_31 = icmp ne i32 %_10, 2
  %not..i = xor i1 %_14, true
  %or.cond.i = select i1 %not..i, i1 true, i1 %_31
  %or.cond3.i = select i1 %or.cond.i, i1 true, i1 %_18
  %or.cond5.i = select i1 %or.cond3.i, i1 true, i1 %_13
  %_32 = icmp ne i32 %_11, 0
  %or.cond7.i = select i1 %or.cond5.i, i1 true, i1 %_32
  br i1 %or.cond7.i, label %orig.main.exit, label %_33

_33:                                              ; preds = %entry
  %_34 = add nsw i64 %_4, %_5
  %_35 = icmp eq i64 %_34, 2
  br label %orig.main.exit

orig.main.exit:                                   ; preds = %_33, %entry
  %_36 = phi i1 [ false, %entry ], [ %_35, %_33 ]
