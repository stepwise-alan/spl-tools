; ModuleID = '/tmp/sea-5_hgtnjt/5_0.pp.ms.o.bc'
source_filename = "5_0.c"
...
entry:
  ...
  %_26 = icmp ne i32 %_10, 2
  %not..i = xor i1 %_14, true
  %or.cond.i = select i1 %not..i, i1 true, i1 %_26
  %or.cond3.i = select i1 %or.cond.i, i1 true, i1 %_18
  %or.cond5.i = select i1 %or.cond3.i, i1 true, i1 %_13
  %_27 = icmp ne i32 %_11, 0
  %or.cond7.i = select i1 %or.cond5.i, i1 true, i1 %_27
  br i1 %or.cond7.i, label %orig.main.exit, label %_28

_28:                                              ; preds = %entry
  %_29 = add nsw i64 %_4, %_5
  %_30 = icmp eq i64 %_29, 2
  br label %orig.main.exit

orig.main.exit:                                   ; preds = %_28, %entry
  %_31 = phi i1 [ false, %entry ], [ %_30, %_28 ]
...
_41:                                              ; preds = %_38
  br i1 %_16, label %_42, label %_44

_42:                                              ; preds = %_41
  %_43 = sub nsw i64 %_7, %_6
  br label %_52

_44:                                              ; preds = %_41
  br i1 %_17, label %_45, label %_52
...
_45:                                              ; preds = %_44
  ...
  %.neg.i = sext i1 %_50 to i64
  %_51 = add nsw i64 %.neg.i, %_48
  br label %_52

_52:                                              ; preds = %_45, %_44, %_42, %_39, %_36, %_33
  %.0.i = phi i64 [ %_34, %_33 ], [ %_37, %_36 ], [ %_40, %_39 ], [ %_43, %_42 ], [ %_51, %_45 ], [ 0, %_44 ]
  %_53 = icmp eq i64 %.0.i, 2
  %spec.select9.v.i = select i1 %_19, i32 %_10, i32 %_11
  %spec.select9.i = sext i32 %spec.select9.v.i to i64
  %.2.i = select i1 %_53, i64 %spec.select9.i, i64 %.0.i
  %.not.i = icmp eq i64 %.2.i, 0
  br i1 %.not.i, label %_61, label %_54

_54:                                              ; preds = %_52
  %_55 = shl i64 %.2.i, 16
  %_56 = ashr i64 %_55, 32
  %.35.i = select i1 %_20, i64 %_56, i64 %.2.i
  %_57 = shl i64 %.35.i, 16
  %_58 = ashr i64 %_57, 32
  %.46.i = select i1 %_20, i64 %_56, i64 %_58
  %_59 = srem i64 %.46.i, 2
  %_60 = add nsw i64 %.46.i, %_59
  br label %_61

_61:                                              ; preds = %_54, %_52
  %.57.i = phi i64 [ %_60, %_54 ], [ %.2.i, %_52 ]
  %.not8.i = icmp eq i64 %.2.i, 2
  br i1 %.not8.i, label %_69, label %_62

_62:                                              ; preds = %_61
  %_63 = shl i64 %.2.i, 16
  %_64 = ashr i64 %_63, 32
  %.3.i = select i1 %_20, i64 %_64, i64 %.2.i
  %_65 = shl i64 %.3.i, 16
  %_66 = ashr i64 %_65, 32
  %.4.i = select i1 %_20, i64 %_64, i64 %_66
  %_67 = srem i64 %.4.i, 2
  %_68 = add nsw i64 %.4.i, %_67
  br label %_69

_69:                                              ; preds = %_62, %_61
  %.5.i = phi i64 [ %_68, %_62 ], [ %.2.i, %_61 ]
  ...
  %_78 = icmp eq i32 %_73, %_77
  call void @verifier.assume.not(i1 %_78)
  br label %_79

_79:                                              ; preds = %_69
  br label %verifier.error

verifier.error:                                   ; preds = %_79
