; ModuleID = '/tmp/sea-wc132g2z/7.pp.ms.o.bc'
source_filename = "7.c"
...
entry:
  ...
  %_27 = call i1 @nondet.bool()
  call void @verifier.assume.not(i1 %_27)
  br label %precall
...
_33:                                              ; preds = %_30
  br i1 %_15, label %_34, label %_36

_34:                                              ; preds = %_33
  %_35 = sub nsw i64 %_5, %_4
  br label %_47

_36:                                              ; preds = %_33
  br i1 %_16, label %_37, label %_39
...
_47:                                              ; preds = %_40, %_39, %_37, %_34, %_31, %_28
  %.0.i = phi i64 [ %_29, %_28 ], [ %_32, %_31 ], [ %_35, %_34 ], [ %_38, %_37 ], [ %_46, %_40 ], [ 0, %_39 ]
  %_48 = icmp eq i64 %.0.i, 2
  %spec.select9.v.i = select i1 %_19, i32 %_10, i32 %_11
  %spec.select9.i = sext i32 %spec.select9.v.i to i64
  %.2.i = select i1 %_48, i64 %spec.select9.i, i64 %.0.i
  %.not.i = icmp eq i64 %.2.i, 0
  br i1 %.not.i, label %_56, label %_49

_49:                                              ; preds = %_47
  %_50 = shl i64 %.2.i, 16
  %_51 = ashr i64 %_50, 32
  %.35.i = select i1 %_20, i64 %_51, i64 %.2.i
  %_52 = shl i64 %.35.i, 16
  %_53 = ashr i64 %_52, 32
  %.46.i = select i1 %_20, i64 %_51, i64 %_53
  %_54 = srem i64 %.46.i, 2
  %_55 = add nsw i64 %.46.i, %_54
  br label %_56

_56:                                              ; preds = %_49, %_47
  %.57.i = phi i64 [ %_55, %_49 ], [ %.2.i, %_47 ]
  %.not8.i = icmp eq i64 %.2.i, 2
  br i1 %.not8.i, label %_64, label %_57

_57:                                              ; preds = %_56
  %_58 = shl i64 %.2.i, 16
  %_59 = ashr i64 %_58, 32
  %.3.i = select i1 %_20, i64 %_59, i64 %.2.i
  %_60 = shl i64 %.3.i, 16
  %_61 = ashr i64 %_60, 32
  %.4.i = select i1 %_20, i64 %_59, i64 %_61
  %_62 = srem i64 %.4.i, 2
  %_63 = add nsw i64 %.4.i, %_62
  br label %_64

_64:                                              ; preds = %_57, %_56
  %.5.i = phi i64 [ %_63, %_57 ], [ %.2.i, %_56 ]
  %_65 = trunc i64 %.57.i to i32
