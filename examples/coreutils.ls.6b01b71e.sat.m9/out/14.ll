; ModuleID = '/tmp/sea-audnj8oh/14.pp.ms.o.bc'
...
_56:                                              ; preds = %_54
  %_57 = shl i64 %.2.i, 16
  %_58 = ashr i64 %_57, 32
  %.3.i = select i1 %_20, i64 %_58, i64 %.2.i
  %_59 = shl i64 %.3.i, 16
  %_60 = ashr i64 %_59, 32
  %.4.i = select i1 %_20, i64 %_58, i64 %_60
  %_61 = srem i64 %.4.i, 2
  %_62 = add nsw i64 %.4.i, %_61
  br label %_63

_63:                                              ; preds = %_56, %_54
  %.5.i = phi i64 [ %_62, %_56 ], [ %.2.i, %_54 ]
