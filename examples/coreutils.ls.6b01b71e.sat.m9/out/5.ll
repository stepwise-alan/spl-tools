; ModuleID = '/tmp/sea-xw4jwf4y/5.pp.ms.o.bc'
source_filename = "5.c"
...
_47:                                              ; preds = %_45
  %_48 = shl i64 %.2.i, 16
  %_49 = ashr i64 %_48, 32
  %.3.i = select i1 %_20, i64 %_49, i64 %.2.i
  %_50 = shl i64 %.3.i, 16
  %_51 = ashr i64 %_50, 32
  %.4.i = select i1 %_20, i64 %_49, i64 %_51
  %_52 = srem i64 %.4.i, 2
  %_53 = add nsw i64 %.4.i, %_52
  br label %_54

_54:                                              ; preds = %_47, %_45
  %.5.i = phi i64 [ %_53, %_47 ], [ %.2.i, %_45 ]
