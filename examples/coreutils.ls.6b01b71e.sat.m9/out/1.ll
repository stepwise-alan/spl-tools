; ModuleID = '/tmp/sea-_v1mjlcv/1.pp.ms.o.bc'
source_filename = "1.c"
...
_43:                                              ; preds = %_41
  %_44 = shl i64 %.2.i, 16
  %_45 = ashr i64 %_44, 32
  %.3.i = select i1 %_20, i64 %_45, i64 %.2.i
  %_46 = shl i64 %.3.i, 16
  %_47 = ashr i64 %_46, 32
  %.4.i = select i1 %_20, i64 %_45, i64 %_47
  %_48 = srem i64 %.4.i, 2
  %_49 = add nsw i64 %.4.i, %_48
  br label %_50

_50:                                              ; preds = %_43, %_41
  %.5.i = phi i64 [ %_49, %_43 ], [ %.2.i, %_41 ]
...
_58:                                              ; preds = %_51, %_50
  %.57.i = phi i64 [ %_57, %_51 ], [ %.2.i, %_50 ]
  %_59 = trunc i64 %.5.i to i32
