; ModuleID = '/tmp/sea-2zqptcc1/7.pp.ms.o.bc'
source_filename = "7.c"
...
_49:                                              ; preds = %_47
  %_50 = shl i64 %.2.i, 16
  %_51 = ashr i64 %_50, 32
  %.3.i = select i1 %_20, i64 %_51, i64 %.2.i
  %_52 = shl i64 %.3.i, 16
  %_53 = ashr i64 %_52, 32
  %.4.i = select i1 %_20, i64 %_51, i64 %_53
  %_54 = srem i64 %.4.i, 2
  %_55 = add nsw i64 %.4.i, %_54
  br label %_56

_56:                                              ; preds = %_49, %_47
  %.5.i = phi i64 [ %_55, %_49 ], [ %.2.i, %_47 ]
