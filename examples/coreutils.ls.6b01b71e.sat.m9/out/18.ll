; ModuleID = '/tmp/sea-25l0339q/18.pp.ms.o.bc'
...
_68:                                              ; preds = %_67
  %_69 = shl i64 %.2.i, 16
  %_70 = ashr i64 %_69, 32
  %.35.i = select i1 %_20, i64 %_70, i64 %.2.i
  %_71 = shl i64 %.35.i, 16
  %_72 = ashr i64 %_71, 32
  %.46.i = select i1 %_20, i64 %_70, i64 %_72
  %_73 = srem i64 %.46.i, 2
  %_74 = add nsw i64 %.46.i, %_73
  br label %_75

_75:                                              ; preds = %_68, %_67
  %.57.i = phi i64 [ %_74, %_68 ], [ %.2.i, %_67 ]
