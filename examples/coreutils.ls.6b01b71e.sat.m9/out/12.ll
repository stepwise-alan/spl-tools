; ModuleID = '/tmp/sea-n_hfwh_z/12.pp.ms.o.bc'
...
_54:                                              ; preds = %_52
  %_55 = shl i64 %.2.i, 16
  %_56 = ashr i64 %_55, 32
  %.3.i = select i1 %_20, i64 %_56, i64 %.2.i
  %_57 = shl i64 %.3.i, 16
  %_58 = ashr i64 %_57, 32
  %.4.i = select i1 %_20, i64 %_56, i64 %_58
  %_59 = srem i64 %.4.i, 2
  %_60 = add nsw i64 %.4.i, %_59
  br label %_61

_61:                                              ; preds = %_54, %_52
  %.5.i = phi i64 [ %_60, %_54 ], [ %.2.i, %_52 ]
...
_62:                                              ; preds = %_61
  %_63 = shl i64 %.2.i, 16
  %_64 = ashr i64 %_63, 32
  %.35.i = select i1 %_20, i64 %_64, i64 %.2.i
  %_65 = shl i64 %.35.i, 16
  %_66 = ashr i64 %_65, 32
  %.46.i = select i1 %_20, i64 %_64, i64 %_66
  %_67 = srem i64 %.46.i, 2
  %_68 = add nsw i64 %.46.i, %_67
  br label %_69

_69:                                              ; preds = %_62, %_61
  %.57.i = phi i64 [ %_68, %_62 ], [ %.2.i, %_61 ]
