; ModuleID = '/tmp/sea-1xzxq6bj/4.pp.ms.o.bc'
source_filename = "4.c"
...
_44:                                              ; preds = %_37, %_36, %_34, %_31, %_28, %_25
  %.0.i = phi i64 [ %_26, %_25 ], [ %_29, %_28 ], [ %_32, %_31 ], [ %_35, %_34 ], [ %_43, %_37 ], [ 0, %_36 ]
  %_45 = icmp eq i64 %.0.i, 2
  %spec.select9.v.i = select i1 %_19, i32 %_10, i32 %_11
  %spec.select9.i = sext i32 %spec.select9.v.i to i64
  %.2.i = select i1 %_45, i64 %spec.select9.i, i64 %.0.i
  %.not.i = icmp eq i64 %.2.i, 0
  br i1 %.not.i, label %_53, label %_46

_46:                                              ; preds = %_44
  %_47 = shl i64 %.2.i, 16
  %_48 = ashr i64 %_47, 32
  %.3.i = select i1 %_20, i64 %_48, i64 %.2.i
  %_49 = shl i64 %.3.i, 16
  %_50 = ashr i64 %_49, 32
  %.4.i = select i1 %_20, i64 %_48, i64 %_50
  %_51 = srem i64 %.4.i, 2
  %_52 = add nsw i64 %.4.i, %_51
  br label %_53

_53:                                              ; preds = %_46, %_44
  %.5.i = phi i64 [ %_52, %_46 ], [ %.2.i, %_44 ]
  %.not8.i = icmp eq i64 %.2.i, 2
  br i1 %.not8.i, label %_61, label %_54
