; ModuleID = '/tmp/sea-1ulvxxqw/17.pp.ms.o.bc'
...
_67:                                              ; preds = %_66
  %_68 = shl i64 %.2.i, 16
  %_69 = ashr i64 %_68, 32
  %.35.i = select i1 %_20, i64 %_69, i64 %.2.i
  %_70 = shl i64 %.35.i, 16
  %_71 = ashr i64 %_70, 32
  %.46.i = select i1 %_20, i64 %_69, i64 %_71
  %_72 = srem i64 %.46.i, 2
  %_73 = add nsw i64 %.46.i, %_72
  br label %_74

_74:                                              ; preds = %_67, %_66
  %.57.i = phi i64 [ %_73, %_67 ], [ %.2.i, %_66 ]
