; ModuleID = '/tmp/sea-8qji0eb9/2.pp.ms.o.bc'
source_filename = "2.c"
...
_44:                                              ; preds = %_42
  %_45 = shl i64 %.2.i, 16
  %_46 = ashr i64 %_45, 32
  %.3.i = select i1 %_20, i64 %_46, i64 %.2.i
  %_47 = shl i64 %.3.i, 16
  %_48 = ashr i64 %_47, 32
  %.4.i = select i1 %_20, i64 %_46, i64 %_48
  %_49 = srem i64 %.4.i, 2
  %_50 = add nsw i64 %.4.i, %_49
  br label %_51

_51:                                              ; preds = %_44, %_42
  %.5.i = phi i64 [ %_50, %_44 ], [ %.2.i, %_42 ]
