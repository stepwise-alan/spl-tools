; ModuleID = '/tmp/sea-54ybkcwz/11.pp.ms.o.bc'
...
_53:                                              ; preds = %_51
  %_54 = shl i64 %.2.i, 16
  %_55 = ashr i64 %_54, 32
  %.3.i = select i1 %_20, i64 %_55, i64 %.2.i
  %_56 = shl i64 %.3.i, 16
  %_57 = ashr i64 %_56, 32
  %.4.i = select i1 %_20, i64 %_55, i64 %_57
  %_58 = srem i64 %.4.i, 2
  %_59 = add nsw i64 %.4.i, %_58
  br label %_60

_60:                                              ; preds = %_53, %_51
  %.5.i = phi i64 [ %_59, %_53 ], [ %.2.i, %_51 ]
